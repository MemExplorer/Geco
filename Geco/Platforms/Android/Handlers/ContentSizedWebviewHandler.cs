...
namespace Geco.Platforms.Android.Handlers
{
	public class ContentSizedWebViewHandler : WebViewHandler
	{
		...
		{
			["WebViewClient"] = MapContentSizedWebViewClient,
			["WebChromeClient"] = MapContentSizedWebChromeClient
		};
		...
		public new Views.Helpers.ContentSizedWebView VirtualView => (Views.Helpers.ContentSizedWebView)base.VirtualView;
