...
public readonly record struct GeminiModelResponse(
	...
	string Description,
	[property: JsonPropertyName("inputTokenLimit")]
	uint InputTokenLimit,
	[property: JsonPropertyName("outputTokenLimit")]
	uint OutputTokenLimit,
	[property: JsonPropertyName("supportedGenerationMethods")]
	string[] SupportedGenerationMethods,
	[property: JsonPropertyName("temperature")]
	float? Temperature,
	[property: JsonPropertyName("maxTemperature")]
